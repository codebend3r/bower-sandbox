  ...
  angular.module('ute.ui.livesite')
    ...
    .constant('uteEnv', (function () {
      ...
      var environment = {
        ...
        cmsFilesURL: 'http://uteqa4.fido.ca/html-fido/cms/ute/fido/resource/',
      ...
      console.log('cmsFilesURL:', environment.cmsFilesURL);
      ...
      return {
        ...
        link: function ($scope, $element, $attrs) {
          ...
          if ($attrs.isCms === 'true') {
            ...
            var path = 'global/header-livesite/header-livesite_' + $rootScope.rui.language + '_' + $rootScope.rui.province + '.html',
